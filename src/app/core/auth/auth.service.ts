...
import { IAdminPermission } from 'app/modules/admin/admin-permission/common/admin-parmission.model'
...
export class AuthService {
  ...
  signIn(credentials: { email: string; password: string }): Observable<any> {
    ...
    return this._baseService.post('admin/auth/signin/local', credentials).pipe(
      switchMap((response: { access_token: string; refresh_token: string; user: IAdminUser }) => {
